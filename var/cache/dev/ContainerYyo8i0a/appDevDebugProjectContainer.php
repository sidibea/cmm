...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('9gHoNInknJ', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Qud0ZLK97U', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EiinPOY8IT', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OmWFs31QQE', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CaGocAMT1v', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('24c166e126e6f75fa4675280c3a27b7611502955')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/CMM/UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/app/Resources/FOSUserBundle/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), '!FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/CMM/MainBundle/Resources/views'), 'CMMMain');
        $instance->addPath(($this->targetDirs[3].'/src/CMM/MainBundle/Resources/views'), '!CMMMain');
        $instance->addPath(($this->targetDirs[3].'/src/CMM/UserBundle/Resources/views'), 'CMMUser');
        $instance->addPath(($this->targetDirs[3].'/src/CMM/AccountBundle/Resources/views'), 'CMMAccount');
        $instance->addPath(($this->targetDirs[3].'/src/CMM/AccountBundle/Resources/views'), '!CMMAccount');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('24c166e126e6f75fa4675280c3a27b7611502955');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'CMMMainBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CMM/MainBundle'),
                    'namespace' => 'CMM\\MainBundle',
                ),
                'CMMUserBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'/src/CMM/UserBundle'),
                    'namespace' => 'CMM\\UserBundle',
                ),
                'CMMAccountBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CMM/AccountBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CMMMainBundle' => 'CMM\\MainBundle\\CMMMainBundle',
                'CMMUserBundle' => 'CMM\\UserBundle\\CMMUserBundle',
                'CMMAccountBundle' => 'CMM\\AccountBundle\\CMMAccountBundle',
            ...
            'database_name' => 'cmm',
            'database_user' => 'root',
            'database_password' => 'sorofing',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '24c166e126e6f75fa4675280c3a27b7611502955',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '24c166e126e6f75fa4675280c3a27b7611502955',
            ...
            'fos_user.model.user.class' => 'CMM\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'sidibesekouassane@gmail.com' => 'CMM',
            ),
