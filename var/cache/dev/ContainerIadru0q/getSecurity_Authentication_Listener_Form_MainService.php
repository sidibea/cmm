...
$c->setOptions(array('login_path' => 'fos_user_security_login', 'target_path_parameter' => 'redirect_url', 'default_target_path' => 'cmm_account_homepage', 'use_referer' => true, 'always_use_default_target_path' => false));
...
$d->setOptions(array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
